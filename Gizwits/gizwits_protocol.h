...
* @{
*/
#define PRODUCT_KEY "7d504a5ec7ff474b991652e0788668b6"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f27a5a5b6ead4f47b92e959870a72212"
...
typedef enum
{
    windspeed_VALUE0 = 0,//low
    windspeed_VALUE1 = 1,//mid
    windspeed_VALUE2 = 2,//high
    windspeed_VALUE_MAX,
} windspeed_ENUM_T;
typedef enum
{
